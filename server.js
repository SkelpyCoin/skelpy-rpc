...
function startServer(port){
  if (program.allowRemote) console.log('Warning! skelpy-rpc allows remote connections, this is potentially insecure!');
  ...
  server = restify.createServer().
    ...
    server.listen(port, function() {
      console.log('skelpy-rpc listening at %s', server.url);
    });
}
