...
const skelpyjs = require('skelpyjs');
...
describe('Accounts', () => {
  ...
  describe('/GET account', () => {
    ...
    //     var address = skelpyjs.crypto.getKeys(bip39.generateMnemonic()).getAddress();
    //     chai.request(server).
  ...
  describe('/POST account', () => {
    ...
    it('it should create transaction from bip38 backup using userid', (done) => {
      ...
      send({
        ...
        skelpyjs.crypto.verify(res.body.transaction).should.be.equal(true);
        done();
      });
    });
